...
{viewerjumpto "Syntax" "fast_destring##syntax"}{...}
{viewerjumpto "Menu" "fast_destring##menu"}{...}
{viewerjumpto "Description" "fast_destring##description"}{...}
{viewerjumpto "Options for destring" "fast_destring##options_destring"}{...}
{viewerjumpto "Options for tostring" "fast_destring##options_tostring"}{...}
{viewerjumpto "Examples" "fast_destring##examples"}{...}
{title:Title}

{p2colset 5 21 23 2}{...}
{p2col :{cmd:fast_destring} {hline 2}}Convert string variables to numeric variables and vice versa{p_end}
{p2colreset}{...}
...
So far, we support
fast_destring [vars], [FLAGVars(vars) DATEVars(vars) DATEFmt(string)] REPLACE
...
{synopt :{cmdab:i:gnore("}{it:chars}{cmd:"} [{cmd:,} {help destring##ignoreopts:{it:ignoreopts}}]{cmd:)}}remove specified nonnumeric characters, as characters or as bytes, and illegal Uni
> code characters{p_end}
